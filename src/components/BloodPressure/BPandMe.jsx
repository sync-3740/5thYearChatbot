...
const BPandMe = (props) => {
  const options = [
    ...
    { text: "Weight", handler: () => {props.actionProvider.handleRequest("Weight"); props.actionProvider.handleNewMessage("For every 10-pound weight gain, the systolic blood pressure goes up 4 to 5 millimeters of mercury. Therefore, you don't have to be overweight or obese for weight gain to raise your blood pressure. Even a small weight loss can help manage or prevent high blood pressure.")}, id: 5 },
    { text: "Waist Circumference", handler: () => {props.actionProvider.handleRequest("Waist Circumference"); props.actionProvider.handleNewMessage("Central obesity where there is fat around the waist has been positively correlated with high blood pressure in several populations.")}, id: 6 },
  ];
