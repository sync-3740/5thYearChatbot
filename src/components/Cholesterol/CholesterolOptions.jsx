...
const CholesterolOptions = (props) => {
  const options = [
    { text: "What is cholesterol?", handler: () => {props.actionProvider.handleRequest("What is cholesterol?"); props.actionProvider.handleNewVideoMessage("Cholesterol is a fat-like substance that is mostly made in the liver. It is carried around the body in structures called lipoproteins, which are “parcels” of fat and protein. The body needs cholesterol for its cells to function, but too much in the blood can lead to heart and blood vessel disease, which can contribute to heart attacks and strokes.", "https://www.youtube.com/embed/kLnvChjGxYk")}, id: 1 },
    ...
    { text: "How do I lower my cholesterol?", handler: () => {props.actionProvider.handleRequest("How do I lower my cholesterol?"); props.actionProvider.handleNewVideoMessage("Eating a healthy diet with less saturated fat can help to lower your cholesterol. So can taking part in regular exercise, stopping smoking and limiting alcohol intake to less than 14 units a week.", "https://www.youtube.com/embed/mOPy1f9-L38")}, id: 5 },
