...
const ACEInhibitors = (props) => {
  const options = [
    { text: "What are ACE Inhibitors?", handler: () => {props.actionProvider.handleRequest("What are ACE Inhibitors?"); props.actionProvider.handleNewVideoMessage("ACE inhibitors are commonly used to treat high blood pressure. They are also used to treat other conditions, such as heart failure, diabetes, kidney disease, and can be given after a heart attack to protect the heart. ACE inhibitors are sometimes used together with other antihypertensives, like calcium channel blockers or diuretics.", "https://www.youtube.com/embed/xIlaQuRaZmk")}, id: 1 },
